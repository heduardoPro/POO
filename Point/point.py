...
class Point:
    ...
    def calculate_distance(self, other_point):
        ...
        distancia = (sqrt(pow((other_point.x - self.x), 2) + pow((other_point.y - self.y), 2)))
...
print("A distancia de p1 e p2 é: ",p1.calculate_distance(p2))
print("A soma de p1 e p2 é:  ",p4)
